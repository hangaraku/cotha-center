        ...
        <div class="flex flex-1 pl-7 pr-8 pb-6 gap-0 relative z-10">
            ...
            <div class="w-[240px] flex flex-col items-center pt-2 shrink-0">
                ...
                <h3 class="text-center font-bold text-base leading-tight mb-4 text-gray-800 tracking-wide">
                    {{ strtoupper($user->name ?? 'STUDENT NAME') }}
                </h3>

                <!-- Final Score -->
                <div class="w-4/5 bg-[#B3E5FC] text-center py-2 rounded-full mb-1">
                    <span class="font-bold text-base text-gray-800">90 - Excellent</span>
                </div>
                ...
                <div class="w-full mb-6">
                    ...
                    <div class="flex gap-3 justify-center">
                        ...
                        <div class="text-[12px] text-gray-500 space-y-0.5 leading-relaxed">
                            @if(isset($projectsList) && count($projectsList) > 0)
                ...
                <!-- Footer Signature -->
                <div class="">
                    <p class="text-xs  text-gray-500 mb-1">Surabaya, 12 Juni 2025</p>
            ...
            <div class="flex-1 flex flex-col gap-4 pt-0 pl-8">
                ...
                <div>
                    ...
                    <div class="bg-[#ecf8ff] py-2.5 px-4 rounded-xl w-full">
                        <h3 class="font-bold text-lg text-center text-gray-800">{{ strtoupper($courseName ?? 'COURSE NAME') }}</h3>
                    </div>
                </div>
                ...
                <div class="flex-1">
                    ...
                    <div class="bg-[#ecf8ff] p-4  rounded-2xl w-full h-[90%]">
                        <p class="text-gray-600 text-[15px] text-center leading-relaxed ">
                            Siswa menunjukkan ritme belajar yang {{ $eff_desc ?? '—' }}, terlihat dari kemampuan menyelesaikan proyek secara {{ $proj_desc ?? '—' }} sesuai tingkatannya. Selama pembelajaran, siswa tampak {{ $active_desc ?? '—' }}, sehingga proses belajarnya terasa lebih hidup. Kehadiran yang {{ $att_desc ?? '—' }} turut {{ $att_impact ?? '—' }} dalam menjaga alur pembelajaran. Secara keseluruhan, siswa menunjukkan {{ $overall_desc ?? '—' }} dan memiliki peluang besar untuk berkembang lebih jauh melalui latihan yang konsisten dan pendampingan yang tepat.
                        </p>
                    </div>
                </div>
