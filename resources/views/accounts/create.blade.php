...
@section('content')
    <div style="background-image: url('{{ asset('images/background-nav-hero.jpg') }}?id={{ now() }}'); background-position: bottom; background-repeat: no-repeat; background-size: cover; min-height: 450px; background-color: #f2f4f9;" class="relative">
        ...
        <div class="flex flex-col justify-center items-start gap-y-4 px-8 sm:px-16 lg:px-24 xl:px-48 py-12 text-white text-left">
            <h1 class="text-3xl md:text-5xl font-extrabold leading-tight mb-2">Tambah Akun Baru</h1>
            <p class="text-lg md:text-2xl font-medium opacity-90">Simpan informasi akun platform pembelajaran Anda</p>
        </div>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 md:p-10 w-full text-black">
            ...
            <div class="mb-8">
                <div class="flex items-center mb-4">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900">Form Tambah Akun</h2>
                </div>
            </div>
            ...
            <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <ul class="text-sm text-blue-700 space-y-1">
                    <li>• Simpan informasi login yang aman dan mudah diingat</li>
                    <li>• Gunakan link platform untuk akses cepat</li>
                    <li>• Informasi ini hanya untuk Anda dan tidak dibagikan</li>
                </ul>
            </div>
        </div>
    </div>
